...
const CardData& card_data(CardType type)
{
    static const CardData table[] = {
        ...
        make_card("Lifeline",
                  "Put up to 3 cards from your graveyard onto the bottom of your deck. Cannot target Lifeline. "
                  "Ghost: Shuffle your graveyard into your deck (except Lifeline), then exile the top 3 undrawn cards.",
        ...
        make_card("Bones", "When played, multiply this round by (1 + n) where n is the number of Bones in your graveyard (including this one).",
        ...
        make_card("Tombstones", "When played, add n to this round where n is the total number of cards in your graveyard (including this one).",
                  0, 0, {}, {}, {}, nullptr, nullptr, false, false, nullptr, nullptr, nullptr, false, false, 0, nullptr, true),
